> **📦 Archived — historical / superseded.** Original Day-1 product requirements (Feb 2026), frozen at the initial vision. The app has since grown well beyond this scope (AI tag suggestions, Spotify, export, play queue, sync modes).
>
